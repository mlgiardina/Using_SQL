...
<p>
  <ol>
    ...
    <li>The total amount spent on books was 1,081,352. I found this info by typing "SELECT sum(price * quantity) FROM orders JOIN items ON items.id = orders.item_id AND category LIKE '%book%';"</li>
